...
abstract class AbstractNumber<N extends AbstractNumber<N>> extends Number implements Comparable<N> {
     ...
     * @return this
     */
    public abstract @NonNull N unaryPlus();
     ...
     * @return negated number
     */
    public final @NonNull N unaryMinus() {
        return negate();
    }
     ...
     * @throws NullPointerException when summand is null
     */
    public final @NonNull N plus(final @NonNull N summand) {
        return add(summand);
    }
     ...
     * @throws NullPointerException when subtrahend is null
     */
    public final @NonNull N minus(final @NonNull N subtrahend) {
