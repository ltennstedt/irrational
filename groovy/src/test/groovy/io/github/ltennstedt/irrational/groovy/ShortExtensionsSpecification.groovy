...
@CompileDynamic
final class ShortExtensionsSpecification extends Specification {
    def "toLongRational should succeed"() {
        when:
        final actual = ((short) 0).toLongRational()
    ...
    def "toBigRational should succeed"() {
        when:
        final actual = ((short) 0).toBigRational()
    ...
    def "toLongGaussian should succeed"() {
        when:
        final actual = ((short) 1).toLongGaussian()
    ...
    def "toBigGaussian should succeed"() {
        when:
        final actual = ((short) 1).toBigGaussian()
    ...
    def "toDoubleComplex should succeed"() {
        when:
        final actual = ((short) 1).toDoubleComplex()
    ...
    def "toBigComplex should succeed"() {
        when:
        final actual = ((short) 1).toBigComplex()
    ...
    def "toDoubleQuaternion should succeed"() {
        when:
        final actual = ((short) 1).toDoubleQuaternion()
    ...
    def "toBigQuaternion should succeed"() {
        when:
        final actual = ((short) 1).toBigQuaternion()
