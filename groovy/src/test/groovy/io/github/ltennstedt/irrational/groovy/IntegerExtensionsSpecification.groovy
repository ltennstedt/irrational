...
@CompileDynamic
final class IntegerExtensionsSpecification extends Specification {
    def "toLongRational should succeed"() {
        when:
        final actual = 0.toLongRational()
    ...
    def "toDoubleComplex should succeed"() {
        when:
        final actual = 1.toDoubleComplex()
    ...
    def "toDoubleQuaternion should succeed"() {
        when:
        final actual = 1.toDoubleQuaternion()
    ...
    def "toBigQuaternion should succeed"() {
        when:
        final actual = 1.toBigQuaternion()
