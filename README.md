...
The Gradle Wrapper is provided to build this project. A JDK will be downloaded automatically if no compatible toolchain
is found locally.
...
* Good test coverage ensured
  by [JUnit](https://junit.org/), [AssertJ](https://assertj.github.io/doc/), [EqualsVerifier](https://jqno.nl/equalsverifier/), [Kotest](https://kotest.io/), [Spock](https://spockframework.org/)
