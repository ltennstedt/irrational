...
* For Java in [build.gradle.kts](https://github.com/ltennstedt/irrational/blob/develop/build.gradle.kts#L86)
* For Gradle in [gradle.properties](https://github.com/ltennstedt/irrational/blob/develop/gradle.properties#L1)
